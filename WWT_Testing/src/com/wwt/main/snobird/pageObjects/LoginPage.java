...
public class LoginPage extends PageObjects {
  ...
  public LoginPage(){
	...
	private void load(){
		...
		String file = projectPath+"\\snobirdPageObjectFiles\\LoginPage.xls" ;
	...
	public void login(String pUserName,String pPassword){
		...
		userName.inputText(pUserName); // @Todo: need to change to take it from excel file
		password.inputText(pPassword);//@Todo: need to change to take it from excel file
		//loginButton.clickAndWait(locator, timeout);
		loginButton.click();
